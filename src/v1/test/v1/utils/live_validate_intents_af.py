...
C_CASES = [
    ...
    Case("TC-019", "C", "Who is working on the fraud alerts delay?",
         {"INC3198040"}, set(),
         "Extract 'fraud alerts' -> Debit Card Fraud Alerts; highlight assignee Marcus Bell."),
...
F_CASES = [
    ...
    Case("TC-032", "F", "Who has handled issues with cur_txn_clearing?",
         {"INC3025540"}, set(),
         "Resolve cur_txn_clearing -> Debit Card Transaction Clearing; Aaron Velasquez."),
    Case("TC-033", "F", "Who's handling the settlement issues?",
         {"INC3220100"}, set(),
         "Extract 'settlement' -> Denver McCollum on INC3220100."),
    ...
    Case("TC-035", "F", "What datasources has Priya Nair worked on?",
         {"INC2965100", "INC3230120"}, set(),
         "Reverse lookup by engineer: Priya Nair -> Loan Application + HOP Enterprise."),
