...
async def servicenow_list_tickets(
    ...
    assigned_to: Annotated[
        ...
        Field(
            description=(
                "ServiceNow user CODE of the assignee, e.g. 'A1001' — NOT a sys_id "
    ...
    resolved_by: Annotated[
        ...
        Field(
            description=(
                "ServiceNow user CODE of the resolver, e.g. 'A1001' (same rules as "
    ...
    assigned_to_contains: Annotated[
        ...
        Field(
            description=(
                ...
                "LAST name alone is enough ('Carter', 'Nakamura'). Use this whenever "
    ...
    assigned_to_name: Annotated[
        ...
        Field(
            description=(
                ...
                "in parentheses, e.g. 'Alex Carter (A1001)'. A bare name without "
    ...
    ticket_numbers: Annotated[
        ...
        Field(
            description=(
                ...
                "call, e.g. 'INC0001201,INC0001601'. ALWAYS use this for two or more "
