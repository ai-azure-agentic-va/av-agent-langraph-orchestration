...
subagent wiring in :mod:`v1.core.subagents.adls`.
"""
...
- list_dataset_files(dataset|path, last_n_days?): the files that ACTUALLY
  landed, newest first, with size and last-modified timestamp.

A single storage account is configured and used automatically; never ask the
