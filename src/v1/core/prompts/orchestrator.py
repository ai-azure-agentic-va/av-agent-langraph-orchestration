...
- PAGING ("show more", "next page", "the rest", "what else", "continue"): the
  subagent is STATELESS — a new delegation cannot see the previous page or the
  paging cursor that produced it. YOU are the only one holding that history, so
  the task text MUST carry it: repeat the ORIGINAL search unchanged AND list
  every incident number already shown in this conversation. E.g. task: `User
  asked: "show me more". Same search as before: incidents for LexisNexis.
  Already shown: INC0001201,INC0001202,INC0001203 — continue after these.`
